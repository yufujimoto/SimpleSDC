...
class mainPanel(QMainWindow, mainWindow.Ui_MainWindow):
    ...
    def importExternalData(self):
        ...
        try:    
            ...
            if self.tab_target.currentIndex() == 0:
                ...
                item_path = os.path.join(os.path.join(self._root_directory, "Materials"), mat_uuid)
                print(item_path)
            else:
                return(None)
            ...
            sop_media.mediaImporter(sop_object, item_path, in_dir[0], mat_uuid, self._database)
    ...
    def retriveProjectItems(self):
        ...
        try:
            ...
            sql_mat_sel = """SELECT uuid, name, description, id FROM material ORDER by id"""
            ...
            for row_mat in rows_mat:
                ...
                tre_prj_mat_items = QTreeWidgetItem(self.tre_prj_item)
    ...
    def addMaterial(self):
        ...
        try:
            ...
            if isAccepted == 1:
                ...
                tre_prj_item_items.setText(0, self._current_material.uuid)
                tre_prj_item_items.setText(1, self._current_material.name)
                
                # Refresh the tree view.
                self.tre_prj_item.show()
                
                # Select the new material from the tree.
        ...
        try:
           # Exit if the root directory is not loaded.
            ...
            if selected.text(0) == mat.uuid:
                ...
                # Delete all files from material directory.
                mat_path = os.path.join(os.path.join(self._root_directory,"Materials"), mat.uuid)
                
                # Delete files.
                shutil.rmtree(mat_path)
                
                # Drop the material from the DB table.
    ...
    def refreshMaterialInfo(self):
        ...
        try:
            ...
            # Clear the file list for material.
            self.tre_fls.clear()
            ...
            with open(in_file[0]) as table:
                ...
                for line in table:
                    ...
                    if cnt_line == 0:
                        ...
                        # Create a new SOP object of file.
                                ...
                                if fil_head[i] == "uuid":
                                    ...
                                    if sop_file.file_type == "image":
                                        ...
                                        if img_ext.lower() == ".jpg":
                                            img_path_main = os.path.join(img_path, "Main")
                                            print(img_path_main)
                                            # Generate the GUID for the image file.
                                            img_uuid = str(uuid.uuid4())
                                            print(img_uuid)
                                            # Define the destination file path.
                                            main_dest = os.path.join(img_path_main, img_uuid + ".jpg")
                                            print(main_dest)
                                            sop_file.filename =  general.getRelativePath(main_dest, "Materials")
                                            print(fil_org)
                                            ...
                                            sop_file.filename =  general.getRelativePath(raw_dest, "Materials")
                                        ...
                                        sop_file.filename =  general.getRelativePath(snd_dest, "Materials")
        ...
        try:
            ...
            if sop_file.file_type == "image":
                ...
                if os.path.exists(img_path):
                    ...
                    img_file.consolidation = ""
                    img_file.filename = general.getRelativePath(new_file, "Materials")
    ...
    def colorlize(self):
        ...
        try:
            ...
            # Get the current object from the selected tab index.
            item_path = os.path.join(os.path.join(self._root_directory, "Materials"), sop_file.material)
    ...
    def recordWithPhoto(self):
        ...
        # Instantiate the consolidation.
        item_path = os.path.join(os.path.join(self._root_directory, "Materials"), sop_object.uuid)
            ...
            if isAccepted == 1:
                ...
                if len(snd_lst_main) > 0:
                    ...
                    for i in range(0, len(snd_lst_main)):
                        ...
                        snd_file.filename = general.getRelativePath(snd_dest, "Materials")
            ...
            if self.dialogTetheredShooting.exec_():
                ...
                if len(img_lst_main) > 0:
                    for i in range(0, len(img_lst_main)):
                        ...
                        img_file.consolidation = ""
                        img_file.filename = general.getRelativePath(main_dest, "Materials")
                ...
                if len(img_lst_raw) > 0:
                    for j in range(0, len(img_lst_raw)):
                        ...
                        raw_file.consolidation = ""
                        raw_file.filename = general.getRelativePath(raw_dest, "Materials")

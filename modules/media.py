...
def mediaImporter(sop_object, item_path, in_dir, mat_uuid, dbfile):
    ...
    if len(raw_files) > 0:
        for raw_file in raw_files:
            ...
            sop_raw_file.filename = general.getRelativePath(main_dest, "Materials")
    ...
    if len(snd_files) > 0:
        for snd_file in snd_files:
            ...
            sop_snd_file.filename = general.getRelativePath(snd_dest, "Materials")
